...
The Analytics tools are the foundation of your SEO agent's knowledge. They allow you to pull basic data or perform complex time-series analysis across **Google Search Console and Google Analytics 4**.
