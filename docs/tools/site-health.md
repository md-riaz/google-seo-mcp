...
The `sites_health_check` (Google) and `traffic_health_check` (GA4 Cross-Platform) tools give your AI agent the ability to perform a comprehensive, automated health check across your properties.
