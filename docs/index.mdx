...
Welcome to the documentation for **Google SEO MCP**. This is a bridge between the performance data of **Google Search Console**, **Bing Webmaster Tools**, **Google Analytics 4**, and the reasoning capabilities of modern AI agents.
...
Google SEO MCP connects to **Google**, **Bing**, and **GA4** in a single server. You can:
