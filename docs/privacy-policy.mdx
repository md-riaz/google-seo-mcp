...
Google SEO MCP is a local command-line (CLI) tool that connects to a user’s Google Search Console and Bing Webmaster Tools accounts to retrieve performance data.

---

## 1. Data Access

Google SEO MCP requests the following Google OAuth scope:
...
Google SEO MCP operates entirely on the user’s local machine.
