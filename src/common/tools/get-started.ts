    ...
    try {
                ...
                tools: [
                    ...(isGoogleEnabled && isGA4Enabled ? [
                        ...
                        },
                        {
                            ...
                            purpose: "Prioritize SEO tasks by combining signals from GSC and GA4.",
                            prefer_over: null,
                            next_tool: null
                        },
                        {
                            name: "brand_analysis",
                            purpose: "Analyze Brand vs Non-Brand performance across both platforms.",
                            prefer_over: null,
                            next_tool: null
                        }
                    ] : [])
            ...
            },
            {
                ...
                tools: [
                    ...
                    ...(isGoogleEnabled ? [
                        {
                            name: "accounts_list",
                            purpose: "List all authorized Google accounts.",
                            prefer_over: null,
                            next_tool: null
                        }
                    ] : [])
        ...
        return {
            content: [{
                type: "text" as const,
                text: JSON.stringify({
                    server_summary: "This server provides comprehensive access to Google Search Console and GA4 data, offering capabilities for analytics, URL inspection, sitemap management, and advanced SEO insights.",
